...
export default function Campushaven() {
  return (
    ...
    style={{backgroundImage:`url(${bg})`}}>
      <div className="absolute top-8 w-full flex justify-center">
        <h1 className="bg-black text-white px-4 py-1 rounded">CampusHaven</h1>
       </div>
       <div className="absolute inset-0 flex items-end justify-center pb-32 gap-10 z-10">
  {/* List */}
  <div className="flex flex-col items-center">
    <span className="mb-2 text-black bg-white text-m font-medium">List</span>
  ...
  {/* Explore */}
  <div className="flex flex-col items-center">
    <span className="mb-2 text-black bg-white text-m font-medium">Explore</span>
    <div className="w-2 h-2 rounded-full bg-black mb-1"></div>
  ...
  {/* Find */}
  <div className="flex flex-col items-center">
    <span className="mb-2 text-black bg-white  text-m font-medium">Find</span>
    <div className="w-2 h-2 rounded-full bg-black mb-1"></div>
    <div className="h-32 w-0.5 bg-black"></div>
      ...
      <div className="absolute bottom-10 w-full flex justify-center z-10">
        <Link to='/getstarted'>
        <button className="bg-black text-white px-6 py-3 rounded-md font-semibold shadow-md">
          Get Started
        </button>
        </Link>
      </div>

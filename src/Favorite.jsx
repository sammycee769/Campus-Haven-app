  ...
  return (
    <div className="flex flex-col justify-between p-6">
      <div>
        ...
        <FaRegHeart className="text-5xl  text-center text-gray-400 mb-4 mx-auto" />
        <h2 className="text-lg  text-center  font-semibold mb-1">Nothing added to favorites</h2>
        <p className="text-sm  text-center  text-gray-500">You can save your favorite listings by tapping the heart icon.</p>
      </div>
...
<div className="fixed bottom-0 left-0 right-0 flex justify-around items-center bg-white py-2 border-t text-sm">
        ...
        <Link to="/favorites" className="flex flex-col items-center text-orange-500">
